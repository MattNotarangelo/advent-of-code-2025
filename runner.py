...
def runner(part_number: str, solution_class: Callable, path: str):
    ...
    # time the sample run
    actual_sample_output = solution_class().solve(sample_input)
    ...
    if samples_match:
        actual_question_output = solution_class().solve(question_input)
